...
def segment_with_layoutlmv3(pdf_path):
    """
    Utilise LayoutLMv3 pour segmenter le contenu du document PDF.
    Le PDF est d'abord converti en image, puis le modèle reçoit l'image, le texte extrait et les bounding boxes normalisées.
    """
    # Convertir le PDF en image
    image = pdf_to_image(pdf_path).convert("RGB")
